...
// Thu Sep  6 21:59:40 2018 by ROOT version 6.12/06
// from TTree LHEF/Analysis tree
// found on file: BulkGraviton_hh_narrow_M2400.root
//////////////////////////////////////////////////////////

#ifndef TRootLHEFParticle_h
#define TRootLHEFParticle_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxRwgt = 982;
   ...
   TRootLHEFParticle(TTree *tree=0);
   virtual ~TRootLHEFParticle();
...
#ifdef TRootLHEFParticle_cxx
TRootLHEFParticle::TRootLHEFParticle(TTree *tree) : fChain(0) 
{
...
TRootLHEFParticle::~TRootLHEFParticle()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TRootLHEFParticle::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TRootLHEFParticle::LoadTree(Long64_t entry)
{
...
void TRootLHEFParticle::Init(TTree *tree)
{
...
Bool_t TRootLHEFParticle::Notify()
{
...
void TRootLHEFParticle::Show(Long64_t entry)
{
...
Int_t TRootLHEFParticle::Cut(Long64_t entry)
{
...
#endif // #ifdef TRootLHEFParticle_cxx
